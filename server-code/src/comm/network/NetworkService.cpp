...
__ENTER_FUNCTION
	...
	evconnlistener* pListener = evconnlistener_new_bind(m_pBase, accept_conn_cb, this,
...
__ENTER_FUNCTION
	...
	m_pIOThread = std::unique_ptr<std::thread>( new std::thread(
								[pBase = m_pBase, _thread_name = thread_name, idService]()
								{ 
									__ENTER_FUNCTION
...
{
__ENTER_FUNCTION
	((CNetworkService*)arg)->OnAccept(fd, addr, socklen, listener);
__LEAVE_FUNCTION
}
