...
CNormalThread::CNormalThread(int32_t nWorkIntervalMS, const std::string& thread_name /*= std::string()*/, on_thread_event_function_t on_thread_process_func /*= on_thread_event_function_t()*/, on_thread_event_function_t on_thread_create_func /*= on_thread_event_function_t()*/, on_thread_event_function_t on_thread_finish_func /*= on_thread_event_function_t() */):m_nWorkIntervalMS(nWorkIntervalMS)
, m_bIsReady(false)
	   , m_bStop(false)
{
	m_Thread = std::unique_ptr<std::thread>(new std::thread([pThis = this,
...
CWorkerThread::CWorkerThread(const std::string& thread_name /*= std::string()*/, on_thread_event_function_t on_thread_create_func /*= on_thread_event_function_t()*/, on_thread_event_function_t on_thread_finish_func /*= on_thread_event_function_t()*/):m_bIsReady(false)
, m_bStop(false)
{
