...
public:
	...
	CDBField& set(const char* v)
	{
		return set<std::string>(v);
	}
	CDBField& set(char* v)
	{
		return set<std::string>(v);
	...
	__ENTER_FUNCTION
		...
		case DB_FIELD_TYPE_TINY_UNSIGNED:
			{
				if (std::is_same<typename std::decay<T>::type, uint8_t>::value)	return true;
			}
			break;
		case DB_FIELD_TYPE_TINY:
			{
				if (std::is_same<typename std::decay<T>::type, int8_t>::value)	return true;
			}
			break;
		case DB_FIELD_TYPE_SHORT_UNSIGNED:
			{
				if (std::is_same<typename std::decay<T>::type, uint16_t>::value) return true;
			}
			break;
		case DB_FIELD_TYPE_SHORT:
			{
				if (std::is_same<typename std::decay<T>::type, int16_t>::value) return true;
			}
			break;
		case DB_FIELD_TYPE_LONG_UNSIGNED:
			{
				if (std::is_same<typename std::decay<T>::type, uint32_t>::value) return true;
			}
			break;
		case DB_FIELD_TYPE_LONG:
			{
				if (std::is_same<typename std::decay<T>::type, int32_t>::value) return true;
			}
			break;
		case DB_FIELD_TYPE_LONGLONG_UNSIGNED:
			{
				if (std::is_same<typename std::decay<T>::type, uint64_t>::value) return true;
			}
			break;
		case DB_FIELD_TYPE_LONGLONG:
			{
				if (std::is_same<typename std::decay<T>::type, int64_t>::value) return true;
			}
			break;
		case DB_FIELD_TYPE_FLOAT:
			{
				if (std::is_same<typename std::decay<T>::type, float> ::value) return true;
			}
			break;
		case DB_FIELD_TYPE_DOUBLE:
			{
				if (std::is_same<typename std::decay<T>::type, double>::value) return true;
			}
			break;
