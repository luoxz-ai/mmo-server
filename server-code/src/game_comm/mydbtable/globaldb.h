...
struct TBLD_DBINFO
{
	...
	static constexpr DB_FIELD_TYPES field_type_enum_list[] = {DB_FIELD_TYPE_SHORT_UNSIGNED,DB_FIELD_TYPE_VARCHAR,DB_FIELD_TYPE_LONG_UNSIGNED,DB_FIELD_TYPE_VARCHAR,DB_FIELD_TYPE_VARCHAR,DB_FIELD_TYPE_VARCHAR};
...
struct TBLD_SERVERLIST
{
	...
	static constexpr DB_FIELD_TYPES field_type_enum_list[] = {DB_FIELD_TYPE_SHORT_UNSIGNED,DB_FIELD_TYPE_VARCHAR,DB_FIELD_TYPE_LONGLONG,DB_FIELD_TYPE_LONG_UNSIGNED,DB_FIELD_TYPE_VARCHAR,DB_FIELD_TYPE_SHORT_UNSIGNED};
	static constexpr bool pri_key_idx[] = {true,false,false,false,false,false};
};
