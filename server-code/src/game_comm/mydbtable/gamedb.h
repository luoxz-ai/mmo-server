...
struct TBLD_GLOBAL_MAIL
{
	...
	static constexpr const char* field_name[] = {"id",		"senderid", "sendername",  "create_time", "flag",
												 "subject", "content",	"filter_type", "filter_data", "attach_data"};
	...
	static constexpr DB_FIELD_TYPES field_type_enum_list[] = {
		DB_FIELD_TYPE_LONGLONG_UNSIGNED, DB_FIELD_TYPE_LONGLONG_UNSIGNED, DB_FIELD_TYPE_VARCHAR,  DB_FIELD_TYPE_LONG_UNSIGNED, DB_FIELD_TYPE_LONGLONG_UNSIGNED,
		DB_FIELD_TYPE_VARCHAR,			 DB_FIELD_TYPE_VARCHAR,			  DB_FIELD_TYPE_LONGLONG, DB_FIELD_TYPE_LONGLONG,	   DB_FIELD_TYPE_BLOB};
...
struct TBLD_ITEM
{
	...
	static constexpr const char* field_name[] = {"id",		"owner_id",	   "itemtype", "position",	 "grid",		 "flag",
												 "pilenum", "expire_time", "dura",	   "dura_limit", "addition_lev", "extra"};
	...
	static constexpr DB_FIELD_TYPES field_type_enum_list[] = {DB_FIELD_TYPE_LONGLONG_UNSIGNED, DB_FIELD_TYPE_LONGLONG_UNSIGNED, DB_FIELD_TYPE_LONG_UNSIGNED,
															  ...
															  DB_FIELD_TYPE_LONG_UNSIGNED,	   DB_FIELD_TYPE_LONG_UNSIGNED,		DB_FIELD_TYPE_LONG_UNSIGNED,
															  DB_FIELD_TYPE_LONG_UNSIGNED,	   DB_FIELD_TYPE_LONG_UNSIGNED,		DB_FIELD_TYPE_BLOB};
