...
struct TBLD_COMMONDATA
{
    ...
    static constexpr auto field_info()
    {
        return std::make_tuple(
            std::make_tuple("id", DB_FIELD_TYPE_LONGLONG_UNSIGNED, true, "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ''"),
    ...
    {
        return "CREATE TABLE `tbld_commondata` ("
...
struct TBLD_COOLDOWN
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_cooldown` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `playerid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家id',"
...
struct TBLD_DATACOUNT
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_datacount` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `playerid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家id',"
...
struct TBLD_GUILD
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_guild` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
...
struct TBLD_ITEM
{
    ...
    static constexpr auto field_info()
    {
        return std::make_tuple(
            ...
            std::make_tuple("extra", DB_FIELD_TYPE_BLOB, false, "  `extra` blob(4096) COMMENT '额外信息'"));
    }
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_item` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `owner_id` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '所有者id',"
               "  `itemtype` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '道具类型编号',"
               "  `position` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '所属包裹类型0:包裹 1:装备槽 100:仓库 101:帮派仓库 102:回购列表 103:邮箱 "
               "104:拍卖行',"
...
struct TBLD_MAIL_ATTACHMENT
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_mail_attachment` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
...
struct TBLD_PLAYER
{
    ...
    static constexpr auto field_info()
    {
        return std::make_tuple(
            ...
            std::make_tuple("record_x", DB_FIELD_TYPE_FLOAT, false, "  `record_x` float(246) NOT NULL DEFAULT '0.0' COMMENT '玩家当前所在地图x'"),
            std::make_tuple("record_y", DB_FIELD_TYPE_FLOAT, false, "  `record_y` float(246) NOT NULL DEFAULT '0.0' COMMENT '玩家当前所在地图y'"),
            std::make_tuple("record_face",
                            DB_FIELD_TYPE_FLOAT,
                            false,
                            "  `record_face` float(246) NOT NULL DEFAULT '0.0' COMMENT '玩家当前所在地图face'"),
            std::make_tuple("home_sceneid",
                            DB_FIELD_TYPE_LONGLONG_UNSIGNED,
                            false,
                            "  `home_sceneid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家回城点对应的地图编号'"),
            std::make_tuple("home_x", DB_FIELD_TYPE_FLOAT, false, "  `home_x` float(246) NOT NULL DEFAULT '0.0' COMMENT '玩家回城点对应的地图x'"),
            std::make_tuple("home_y", DB_FIELD_TYPE_FLOAT, false, "  `home_y` float(246) NOT NULL DEFAULT '0.0' COMMENT '玩家回城点对应的地图y'"),
            std::make_tuple("home_face",
                            DB_FIELD_TYPE_FLOAT,
                            false,
                            "  `home_face` float(246) NOT NULL DEFAULT '0.0' COMMENT '玩家回城点对应的地图face'"),
    ...
    static constexpr auto keys_info()
    {
        return std::make_tuple(std::make_tuple("idx_name", "name"),
                               std::make_tuple("idx_create_time", "create_time"),
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_player` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `worldid` smallint(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '服务器编号',"
               "  `oriworldid` smallint(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建角色时的服务器编号',"
               "  `openid` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '玩家账号',"
               ...
               "  `record_sceneid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家当前所在的地图编号',"
               "  `record_x` float(24,6) NOT NULL DEFAULT '0.0' COMMENT '玩家当前所在地图x',"
               "  `record_y` float(24,6) NOT NULL DEFAULT '0.0' COMMENT '玩家当前所在地图y',"
               "  `record_face` float(24,6) NOT NULL DEFAULT '0.0' COMMENT '玩家当前所在地图face',"
               "  `home_sceneid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家回城点对应的地图编号',"
               "  `home_x` float(24,6) NOT NULL DEFAULT '0.0' COMMENT '玩家回城点对应的地图x',"
               "  `home_y` float(24,6) NOT NULL DEFAULT '0.0' COMMENT '玩家回城点对应的地图y',"
               "  `home_face` float(24,6) NOT NULL DEFAULT '0.0' COMMENT '玩家回城点对应的地图face',"
               "  `mate_id` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '伴侣ID',"
               "  `mate_name` varchar(32) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '伴侣名字',"
...
struct TBLD_PLAYER_GUILDINFO
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_player_guildinfo` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `guildid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'guildid',"
...
struct TBLD_SKILL
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_skill` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
...
struct TBLD_ACHIEVEMENT
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_achievement` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `userid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家id',"
...
struct TBLD_STATUS
{
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_status` ("
               "  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '',"
               "  `userid` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '玩家id',"
...
struct TBLD_SYSTEMVAR
{
    ...
    {
        return std::make_tuple(
            std::make_tuple("keyidx", DB_FIELD_TYPE_LONGLONG_UNSIGNED, true, "  `keyidx` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ''"),
            std::make_tuple("name",
                            DB_FIELD_TYPE_VARCHAR,
                            false,
    ...
    static constexpr const char* create_sql()
    {
        return "CREATE TABLE `tbld_systemvar` ("
