...
PROTOBUF_NAMESPACE_OPEN
template<> ::db::tbld_dbinfo* Arena::CreateMaybeMessage<::db::tbld_dbinfo>(Arena*);
template<> ::db::tbld_globalvar* Arena::CreateMaybeMessage<::db::tbld_globalvar>(Arena*);
template<> ::db::tbld_gmlist* Arena::CreateMaybeMessage<::db::tbld_gmlist>(Arena*);
template<> ::db::tbld_serverlist* Arena::CreateMaybeMessage<::db::tbld_serverlist>(Arena*);
template<> ::db::tbld_servicedetail* Arena::CreateMaybeMessage<::db::tbld_servicedetail>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace db {
...
class tbld_dbinfo :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:db.tbld_dbinfo) */ {
 public:
  tbld_dbinfo();
  virtual ~tbld_dbinfo();
  ...
  static inline const tbld_dbinfo* internal_default_instance() {
    return reinterpret_cast<const tbld_dbinfo*>(
               &_tbld_dbinfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(tbld_dbinfo& a, tbld_dbinfo& b) {
    a.Swap(&b);
  }
  ...
  inline tbld_dbinfo* New() const final {
    return CreateMaybeMessage<tbld_dbinfo>(nullptr);
  }

  tbld_dbinfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<tbld_dbinfo>(arena);
  }
...
class tbld_globalvar :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:db.tbld_globalvar) */ {
 public:
  tbld_globalvar();
  ...
  static inline const tbld_globalvar* internal_default_instance() {
    return reinterpret_cast<const tbld_globalvar*>(
               &_tbld_globalvar_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(tbld_globalvar& a, tbld_globalvar& b) {
    a.Swap(&b);
  }
  ...
  inline tbld_globalvar* New() const final {
    return CreateMaybeMessage<tbld_globalvar>(nullptr);
  }

  tbld_globalvar* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<tbld_globalvar>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
...
class tbld_gmlist :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:db.tbld_gmlist) */ {
 public:
  tbld_gmlist();
  virtual ~tbld_gmlist();
  ...
  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const tbld_gmlist* internal_default_instance() {
    return reinterpret_cast<const tbld_gmlist*>(
               &_tbld_gmlist_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(tbld_gmlist& a, tbld_gmlist& b) {
    a.Swap(&b);
  }
  ...
  inline tbld_gmlist* New() const final {
    return CreateMaybeMessage<tbld_gmlist>(nullptr);
  }

  tbld_gmlist* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<tbld_gmlist>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
...
class tbld_serverlist :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:db.tbld_serverlist) */ {
 public:
  tbld_serverlist();
  ...
  static inline const tbld_serverlist* internal_default_instance() {
    return reinterpret_cast<const tbld_serverlist*>(
               &_tbld_serverlist_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(tbld_serverlist& a, tbld_serverlist& b) {
    a.Swap(&b);
  }
  ...
  inline tbld_serverlist* New() const final {
    return CreateMaybeMessage<tbld_serverlist>(nullptr);
  }

  tbld_serverlist* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<tbld_serverlist>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_open_time() const;
...
class tbld_servicedetail :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:db.tbld_servicedetail) */ {
 public:
  tbld_servicedetail();
  ...
  static inline const tbld_servicedetail* internal_default_instance() {
    return reinterpret_cast<const tbld_servicedetail*>(
               &_tbld_servicedetail_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(tbld_servicedetail& a, tbld_servicedetail& b) {
    a.Swap(&b);
  }
  ...
  inline tbld_servicedetail* New() const final {
    return CreateMaybeMessage<tbld_servicedetail>(nullptr);
  }

  tbld_servicedetail* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<tbld_servicedetail>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  ...
  enum : int {
    ...
    kRouteAddrFieldNumber = 4,
    kPublishAddrFieldNumber = 6,
    kBindAddrFieldNumber = 9,
    kWorldidFieldNumber = 1,
    kServiceidFieldNumber = 2,
    kRoutePortFieldNumber = 5,
    kPublishPortFieldNumber = 7,
    kDebugPortFieldNumber = 8,
  };
  ...
  void _internal_set_service_type(const std::string& value);
...
// uint32 worldid = 1 [(.sql) = {
inline void tbld_dbinfo::clear_worldid() {
  worldid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_dbinfo::_internal_worldid() const {
  return worldid_;
}
...
inline void tbld_dbinfo::_internal_set_worldid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// string db_ip = 2 [(.sql) = {
inline void tbld_dbinfo::clear_db_ip() {
...
inline const std::string& tbld_dbinfo::_internal_db_ip() const {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_dbinfo::_internal_db_port() const {
  return db_port_;
}
...
inline void tbld_dbinfo::_internal_set_db_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// string db_name = 4 [(.sql) = {
inline void tbld_dbinfo::clear_db_name() {
...
inline const std::string& tbld_dbinfo::_internal_db_name() const {
...
// string db_user = 5 [(.sql) = {
inline void tbld_dbinfo::clear_db_user() {
...
inline const std::string& tbld_dbinfo::_internal_db_user() const {
  return db_user_.GetNoArena();
}
...
// string db_passwd = 6 [(.sql) = {
inline void tbld_dbinfo::clear_db_passwd() {
...
inline const std::string& tbld_dbinfo::_internal_db_passwd() const {
...
// uint32 key = 1 [(.sql) = {
inline void tbld_globalvar::clear_key() {
  key_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_globalvar::_internal_key() const {
  return key_;
}
...
inline void tbld_globalvar::_internal_set_key(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// uint64 value0 = 2;
inline void tbld_globalvar::clear_value0() {
  value0_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_globalvar::_internal_value0() const {
  return value0_;
}
...
inline void tbld_globalvar::_internal_set_value0(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// uint64 value1 = 3;
inline void tbld_globalvar::clear_value1() {
  value1_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_globalvar::_internal_value1() const {
  return value1_;
}
...
inline void tbld_globalvar::_internal_set_value1(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// uint64 value2 = 4;
inline void tbld_globalvar::clear_value2() {
  value2_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_globalvar::_internal_value2() const {
  return value2_;
}
...
inline void tbld_globalvar::_internal_set_value2(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// uint64 value3 = 5;
inline void tbld_globalvar::clear_value3() {
  value3_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_globalvar::_internal_value3() const {
  return value3_;
}
...
inline void tbld_globalvar::_internal_set_value3(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline const std::string& tbld_globalvar::_internal_value_str0() const {
  return value_str0_.GetNoArena();
}
...
inline const std::string& tbld_globalvar::_internal_value_str1() const {
  return value_str1_.GetNoArena();
}
...
inline const std::string& tbld_globalvar::_internal_value_str2() const {
  return value_str2_.GetNoArena();
}
...
inline const std::string& tbld_globalvar::_internal_value_str3() const {
  return value_str3_.GetNoArena();
}
...
// uint64 id = 1 [(.sql) = {
inline void tbld_gmlist::clear_id() {
  id_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_gmlist::_internal_id() const {
  return id_;
}
...
inline void tbld_gmlist::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
// string openid = 2 [(.sql) = {
inline void tbld_gmlist::clear_openid() {
...
inline const std::string& tbld_gmlist::_internal_openid() const {
...
// uint32 gmlev = 3;
inline void tbld_gmlist::clear_gmlev() {
  gmlev_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_gmlist::_internal_gmlev() const {
  return gmlev_;
}
...
inline void tbld_gmlist::_internal_set_gmlev(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// uint32 worldid = 1 [(.sql) = {
inline void tbld_serverlist::clear_worldid() {
  worldid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_serverlist::_internal_worldid() const {
  return worldid_;
}
...
inline void tbld_serverlist::_internal_set_worldid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline const std::string& tbld_serverlist::_internal_server_name() const {
...
// uint64 open_time = 3;
inline void tbld_serverlist::clear_open_time() {
  open_time_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_serverlist::_internal_open_time() const {
  return open_time_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_serverlist::open_time() const {
  // @@protoc_insertion_point(field_get:db.tbld_serverlist.open_time)
  return _internal_open_time();
}
inline void tbld_serverlist::_internal_set_open_time(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  open_time_ = value;
}
inline void tbld_serverlist::set_open_time(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_open_time(value);
  // @@protoc_insertion_point(field_set:db.tbld_serverlist.open_time)
}

// uint32 open_status = 4;
inline void tbld_serverlist::clear_open_status() {
  open_status_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_serverlist::_internal_open_status() const {
  return open_status_;
}
...
inline void tbld_serverlist::_internal_set_open_status(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline const std::string& tbld_serverlist::_internal_publish_addr() const {
  return publish_addr_.GetNoArena();
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_serverlist::_internal_mergeto() const {
  return mergeto_;
}
...
inline void tbld_serverlist::_internal_set_mergeto(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// uint32 worldid = 1 [(.sql) = {
inline void tbld_servicedetail::clear_worldid() {
  worldid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::_internal_worldid() const {
  return worldid_;
}
...
inline void tbld_servicedetail::_internal_set_worldid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
// uint32 serviceid = 2 [(.sql) = {
inline void tbld_servicedetail::clear_serviceid() {
  serviceid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::_internal_serviceid() const {
  return serviceid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::serviceid() const {
  // @@protoc_insertion_point(field_get:db.tbld_servicedetail.serviceid)
  return _internal_serviceid();
}
inline void tbld_servicedetail::_internal_set_serviceid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  serviceid_ = value;
}
inline void tbld_servicedetail::set_serviceid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_serviceid(value);
  // @@protoc_insertion_point(field_set:db.tbld_servicedetail.serviceid)
}

// string service_type = 3 [(.sql) = {
inline void tbld_servicedetail::clear_service_type() {
  service_type_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& tbld_servicedetail::service_type() const {
  // @@protoc_insertion_point(field_get:db.tbld_servicedetail.service_type)
  return _internal_service_type();
}
inline void tbld_servicedetail::set_service_type(const std::string& value) {
  _internal_set_service_type(value);
  // @@protoc_insertion_point(field_set:db.tbld_servicedetail.service_type)
}
inline std::string* tbld_servicedetail::mutable_service_type() {
  // @@protoc_insertion_point(field_mutable:db.tbld_servicedetail.service_type)
  return _internal_mutable_service_type();
}
inline const std::string& tbld_servicedetail::_internal_service_type() const {
  return service_type_.GetNoArena();
}
inline void tbld_servicedetail::_internal_set_service_type(const std::string& value) {
  
  service_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void tbld_servicedetail::set_service_type(std::string&& value) {
  
  service_type_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:db.tbld_servicedetail.service_type)
}
inline void tbld_servicedetail::set_service_type(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  service_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:db.tbld_servicedetail.service_type)
}
inline void tbld_servicedetail::set_service_type(const char* value, size_t size) {
  
  service_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:db.tbld_servicedetail.service_type)
}
inline std::string* tbld_servicedetail::_internal_mutable_service_type() {
  
  return service_type_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* tbld_servicedetail::release_service_type() {
  // @@protoc_insertion_point(field_release:db.tbld_servicedetail.service_type)
  
  return service_type_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void tbld_servicedetail::set_allocated_service_type(std::string* service_type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:db.tbld_servicedetail.service_type)
}
...
inline const std::string& tbld_servicedetail::_internal_route_addr() const {
  return route_addr_.GetNoArena();
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::_internal_route_port() const {
  return route_port_;
}
...
inline void tbld_servicedetail::_internal_set_route_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline const std::string& tbld_servicedetail::_internal_publish_addr() const {
  return publish_addr_.GetNoArena();
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::_internal_publish_port() const {
...
inline void tbld_servicedetail::_internal_set_publish_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::_internal_debug_port() const {
  return debug_port_;
}
...
inline void tbld_servicedetail::_internal_set_debug_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline const std::string& tbld_servicedetail::_internal_bind_addr() const {
  return bind_addr_.GetNoArena();
}
