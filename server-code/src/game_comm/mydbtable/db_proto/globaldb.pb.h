...
inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_serverlist::_internal_open_time() const {
  return open_time_;
}
...
inline void tbld_serverlist::_internal_set_open_time(::PROTOBUF_NAMESPACE_ID::uint32 value) {
