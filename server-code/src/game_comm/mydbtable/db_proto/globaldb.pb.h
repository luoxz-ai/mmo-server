...
namespace db
{
    ...
    public:
        ...
        {
            return reinterpret_cast<const tbld_dbinfo*>(&_tbld_dbinfo_default_instance_);
        }
    ...
    public:
        ...
        {
            return reinterpret_cast<const tbld_gmlist*>(&_tbld_gmlist_default_instance_);
        }
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
    ...
    inline void tbld_serverlist::set_allocated_server_name(std::string* server_name)
    {
        ...
        server_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                         server_name);
        // @@protoc_insertion_point(field_set_allocated:db.tbld_serverlist.server_name)
    }

    // uint64 open_time = 3;
    inline void                            tbld_serverlist::clear_open_time() { open_time_ = PROTOBUF_ULONGLONG(0); }
    inline ::PROTOBUF_NAMESPACE_ID::uint64 tbld_serverlist::_internal_open_time() const { return open_time_; }
    ...
    inline void tbld_serverlist::_internal_set_open_time(::PROTOBUF_NAMESPACE_ID::uint64 value) { open_time_ = value; }
    ...
    inline void tbld_serverlist::set_allocated_publish_addr(std::string* publish_addr)
    {
        ...
        publish_addr_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                          publish_addr);
    ...
    // uint32 serviceid = 2 [(.sql) = {
    inline void                            tbld_servicedetail::clear_serviceid() { serviceid_ = 0u; }
    inline ::PROTOBUF_NAMESPACE_ID::uint32 tbld_servicedetail::_internal_serviceid() const { return serviceid_; }
    ...
    inline const std::string& tbld_servicedetail::_internal_service_type() const { return service_type_.GetNoArena(); }
    ...
    inline void tbld_servicedetail::set_service_type(std::string&& value)
    {
        ...
        service_type_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
    ...
    inline void tbld_servicedetail::set_allocated_service_type(std::string* service_type)
    {
        ...
        service_type_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                          service_type);
