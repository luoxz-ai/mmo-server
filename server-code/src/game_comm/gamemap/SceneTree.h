...
public:
	...
	void SetViewRangeIn(uint32_t val) {	m_nViewRangeIn = val; m_nViewRangeInSquare = m_nViewRangeIn * m_nViewRangeIn; }
	uint32_t GetViewRangeInSquare() const { return m_nViewRangeInSquare; }

	uint32_t GetViewRangeOut() const { return m_nViewRangeOut; }
	void SetViewRangeOut(uint32_t val) { m_nViewRangeOut = val; m_nViewRangeOutSquare = m_nViewRangeOut * m_nViewRangeOut; }
