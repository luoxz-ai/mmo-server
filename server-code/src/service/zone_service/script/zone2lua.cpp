...
void zone2lua(lua_State* L)
{
	...
	lua_tinker::class_def<CActor>(
		L, "GetAttrib",
		lua_tinker::args_type_overload_member_functor(lua_tinker::make_member_functor_ptr((CActorAttrib & (CActor::*)())(&CActor::GetAttrib)),
	...
	lua_tinker::class_def<CActorStatus>(L, "OnAttack", &CActorStatus::OnAttack);
	lua_tinker::class_def<CActorStatus>(L, "OnBeAttack", &CActorStatus::OnBeAttack);
	lua_tinker::class_def<CActorStatus>(L, "OnDead", &CActorStatus::OnDead);
	lua_tinker::class_def<CActorStatus>(L, "OnLeaveMap", &CActorStatus::OnLeaveMap);
	lua_tinker::class_def<CActorStatus>(L, "OnLogin", &CActorStatus::OnLogin);
	lua_tinker::class_def<CActorStatus>(L, "OnLogout", &CActorStatus::OnLogout);
	lua_tinker::class_def<CActorStatus>(L, "OnMove", &CActorStatus::OnMove);
	lua_tinker::class_def<CActorStatus>(L, "OnSkill", &CActorStatus::OnSkill);
	...
	lua_tinker::class_def<CCoolDownSet>(L, "IsCoolDown",
	...
	lua_tinker::class_def<CItem>(
		L, "IsCombineEnable",
		lua_tinker::args_type_overload_member_functor(lua_tinker::make_member_functor_ptr((bool (CItem::*)(CItem*))(&CItem::IsCombineEnable)),
													  lua_tinker::make_member_functor_ptr((bool (CItem::*)(OBJID, DWORD))(&CItem::IsCombineEnable))));
	...
	lua_tinker::class_def<CPackage>(
		L, "CombineAddItem",
		lua_tinker::args_type_overload_member_functor(
			lua_tinker::make_member_functor_ptr((bool (CPackage::*)(CItem*, bool))(&CPackage::CombineAddItem), 1 /*default_args_count*/, 1 /*default_args_start*/),
	...
	lua_tinker::class_def<CPackage>(
		...
		lua_tinker::args_type_overload_member_functor(
			...
			lua_tinker::make_member_functor_ptr((bool (CPackage::*)(uint32_t))(&CPackage::IsFull), 1 /*default_args_count*/, 1 /*default_args_start*/),
			lua_tinker::make_member_functor_ptr((bool (CPackage::*)(uint32_t, uint32_t, DWORD))(&CPackage::IsFull), 1 /*default_args_count*/, 2 /*default_args_start*/)),
		1, 0);
	...
	lua_tinker::class_def<CPlayerTask>(
		L, "CanAccept",
		lua_tinker::args_type_overload_member_functor(lua_tinker::make_member_functor_ptr((bool (CPlayerTask::*)(CTaskType*))(&CPlayerTask::CanAccept)),
													  lua_tinker::make_member_functor_ptr((bool (CPlayerTask::*)(uint32_t))(&CPlayerTask::CanAccept))));
	lua_tinker::class_def<CPlayerTask>(
		L, "CanSubmit",
		lua_tinker::args_type_overload_member_functor(lua_tinker::make_member_functor_ptr((bool (CPlayerTask::*)(CTaskType*))(&CPlayerTask::CanSubmit)),
	...
	lua_tinker::class_def<CPlayerTask>(
		L, "SendTaskInfo",
		lua_tinker::args_type_overload_member_functor(lua_tinker::make_member_functor_ptr((void (CPlayerTask::*)())(&CPlayerTask::SendTaskInfo)),
	...
	lua_tinker::class_def<CSystemVar>(L, "ClearModify", &CSystemVar::ClearModify);
