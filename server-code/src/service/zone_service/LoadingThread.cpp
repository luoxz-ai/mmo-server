...
:m_pZone(pZoneRef)
,m_Thread(50, std::string("Loading") + std::to_string(pZoneRef->GetServerPort().GetServiceID()), 
			std::bind(&CLoadingThread::OnThreadProcess,this), std::bind(&CLoadingThread::OnThreadCreate, this) )
, m_idCurProcess(0)
, m_idNeedCancle(0)
{
