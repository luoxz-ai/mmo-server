...
__ENTER_FUNCTION
	...
	auto result = pDB->Query(TBLD_COMMONDATA::table_name, fmt::format("SELECT * FROM {} WHERE {}={}", TBLD_COMMONDATA::table_name,TBLD_COMMONDATA::field_name[TBLD_COMMONDATA::PLAYERID],pPlayer->GetID()));
	if (result)
	{
