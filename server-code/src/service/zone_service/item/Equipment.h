...
public:
	...
	export_lua bool DecEquipmentDurability(bool bBeAttack, bool bMagic, int nDecValue = 1);
	export_lua void AddEquipmentDurability(uint32_t nPosition, int nAddValue);
...
protected:
	...
	typedef std::multimap<DWORD, UCHAR> EXPIRE_ITEM_SET;
