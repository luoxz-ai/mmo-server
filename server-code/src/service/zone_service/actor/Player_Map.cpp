...
{
__ENTER_FUNCTION
	return EventManager()->ScheduleEvent(EVENTID_FLYMAP, std::bind(&CPlayer::_FlyMap, this, pScene->GetSceneID(), fPosX, fPosY, fRange, fFace), 0, false, GetEventMapRef());
__LEAVE_FUNCTION
	return false;
}
...
__ENTER_FUNCTION
	...
	else
	{
		...
		{
			//切换zone
			EventManager()->ScheduleEvent(EVENTID_FLYMAP, std::bind(&CPlayer::_ChangeZone, this, SceneID(idZone, idMap, 0), fPosX, fPosY, fRange, fFace), 0, false, GetEventMapRef());
