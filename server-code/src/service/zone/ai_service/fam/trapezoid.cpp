...
fuzzy::Trapezoid::Trapezoid(const double l, const double tl, const double tr, const double r, const double h)
    ...
    , _height(h)
{
    if((_left > _top_left) || (_top_left > _top_right) || (_top_right > _right) || (_height < 0) || (_height > 1))
    {
...
{
    return (_left == other._left && _top_left == other._top_left && _top_right == other._top_right && _right == other._right &&
