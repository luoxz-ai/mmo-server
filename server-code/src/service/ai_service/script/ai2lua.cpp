...
lua_tinker::class_def<CNetworkMessage>(L, "GetMsgBody", lua_tinker::args_type_overload_member_functor(
...
lua_tinker::class_def<CNetworkMessage>(L, "GetMsgHead", lua_tinker::args_type_overload_member_functor(
...
lua_tinker::class_def<CNetworkMessage>(L, "SetMultiIDTo", lua_tinker::args_type_overload_member_functor(
...
lua_tinker::class_def<CNetworkMessage>(L, "SetMultiTo", lua_tinker::args_type_overload_member_functor(
...
lua_tinker::class_con<CNetworkMessage>(L,lua_tinker::args_type_overload_constructor(
	...
	new lua_tinker::constructor<CNetworkMessage, uint16_t, byte *, size_t, VirtualSocket, VirtualSocket, VirtualSocket>(3 /*default_args_count*/, 4 /*default_args_start*/ ), 
	new lua_tinker::constructor<CNetworkMessage, uint16_t, const ::google::protobuf::Message &, VirtualSocket, VirtualSocket, VirtualSocket>(3 /*default_args_count*/, 7 /*default_args_start*/ )), 0, 0, 0, 0, 0, 0, 0, 0, 0);
...
lua_tinker::class_con<ServerPort>(L,lua_tinker::args_type_overload_constructor(
	new lua_tinker::constructor<ServerPort, const ServerPort &>(), 
	new lua_tinker::constructor<ServerPort, uint16_t, uint16_t>(), 
	new lua_tinker::constructor<ServerPort, uint32_t>(1 /*default_args_count*/, 1 /*default_args_start*/ )), 0);
...
lua_tinker::class_con<VirtualSocket>(L,lua_tinker::args_type_overload_constructor(
	...
	new lua_tinker::constructor<VirtualSocket, uint64_t>(1 /*default_args_count*/, 1 /*default_args_start*/ )), 0);
