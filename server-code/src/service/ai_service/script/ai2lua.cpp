...
void ai2lua(lua_State* L)
{
    ...
    lua_tinker::class_def<CAIScene>(
        ...
        "CreatePhase",
        lua_tinker::args_type_overload_member_functor(
            lua_tinker::make_member_functor_ptr((CAIPhase * (CAIScene::*)(const SceneIdx&, uint64_t))(&CAIScene::CreatePhase)),
            lua_tinker::make_member_functor_ptr((CAIPhase * (CAIScene::*)(const SceneIdx&, uint64_t, const PhaseData*))(&CAIScene::CreatePhase))));
