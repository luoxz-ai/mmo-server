...
const fuzzy::Trapezoid distance_fuzzy[]=
{
	{-15, -2.5, 2.5, 15},
	{2.5, 15, 15, 30},
	{15, 30, 50, 65}
...
public:
	...
	bool Init(const Cfg_SkillFAM_Row& row)
	{
        ...
        m_rule_set.add( fuzzy::Rule{std::vector<fuzzy::Trapezoid>{distance_fuzzy[dis_idx], hp_fuzzy[hp_idx], mp_fuzzy[mp_idx], hp_fuzzy[target_hp_idx] }, 
									oper_type, like_fuzzy[like_idx]} );
