...
class FileServiceImpl : public FileService
{
  public:
	...
	{
		butil::intrusive_ptr<brpc::ProgressiveAttachment> pa((brpc::ProgressiveAttachment*)arg);
		if(pa == NULL)
		{
						...
						google::protobuf::Closure* done)
	{
		...
		if(filename == "largefile")
		{
			...
			bthread_t th;
			bthread_start_background(&th, NULL, SendLargeFile, cntl->CreateProgressiveAttachment());
		}
		else
		{
...
int main(int argc, char* argv[])
{
	...
	options.internal_port						 = 20000 + FLAGS_port;
