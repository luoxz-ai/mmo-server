...
{
public:
    export_lua enum Extent { EXTENT_NULL, EXTENT_FINITE, EXTENT_INFINITE };
...
public:
    ...
    */
     ...
     */
    export_lua inline const Vector3& getMinimum(void) const { return mMinimum; }

    /** Gets a modifiable version of the minimum
    corner of the box.
    */
    export_lua inline Vector3& getMinimum(void) { return mMinimum; }

    /** Gets the maximum corner of the box.
     */
    export_lua inline const Vector3& getMaximum(void) const { return mMaximum; }

    /** Gets a modifiable version of the maximum
    corner of the box.
    */
    export_lua inline Vector3& getMaximum(void) { return mMaximum; }
    ...
    */
    export_lua inline void setMinimumX(float x) { mMinimum.x = x; }

    export_lua inline void setMinimumY(float y) { mMinimum.y = y; }

    export_lua inline void setMinimumZ(float z) { mMinimum.z = z; }
    ...
    used to resize only one dimension of the box
    */
    export_lua inline void setMaximumX(float x) { mMaximum.x = x; }

    export_lua inline void setMaximumY(float y) { mMaximum.y = y; }

    export_lua inline void setMaximumZ(float z) { mMaximum.z = z; }
    ...
    */
     ...
     */
    export_lua inline void setNull() { mExtent = EXTENT_NULL; }

    /** Returns true if the box is null i.e. empty.
     */
    export_lua inline bool isNull(void) const { return (mExtent == EXTENT_NULL); }

    /** Returns true if the box is finite.
     */
    export_lua bool isFinite(void) const { return (mExtent == EXTENT_FINITE); }

    /** Sets the box to 'infinite'
     */
    export_lua inline void setInfinite() { mExtent = EXTENT_INFINITE; }

    /** Returns true if the box is infinite.
     */
    export_lua bool isInfinite(void) const { return (mExtent == EXTENT_INFINITE); }
    ...
    export_lua float distance(const Vector3& v) const { return Math::Sqrt(squaredDistance(v)); }
