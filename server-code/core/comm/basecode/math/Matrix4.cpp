...
//-----------------------------------------------------------------------
static float MINOR(const TransformBasefloat& m, const size_t r0, const size_t r1, const size_t r2, const size_t c0, const size_t c1, const size_t c2)
{
...
//-----------------------------------------------------------------------
float TransformBasefloat::determinant() const
{
    return m[0][0] * MINOR(*this, 1, 2, 3, 1, 2, 3) - m[0][1] * MINOR(*this, 1, 2, 3, 0, 2, 3) + m[0][2] * MINOR(*this, 1, 2, 3, 0, 1, 3) -
...
Matrix4 Matrix4::inverse() const
{
    ...
    return Matrix4(d00, d01, d02, d03, d10, d11, d12, d13, d20, d21, d22, d23, d30, d31, d32, d33);
}
//-----------------------------------------------------------------------
Affine3 Affine3::inverse() const
{
    ...
    return Affine3(r00, r01, r02, r03, r10, r11, r12, r13, r20, r21, r22, r23);
}
//-----------------------------------------------------------------------
void TransformBasefloat::makeTransform(const Vector3& position, const Vector3& scale, const Quaternion& orientation)
{
    // Ordering:
    //    1. Scale
    //    2. Rotate
...
//-----------------------------------------------------------------------
void TransformBasefloat::makeInverseTransform(const Vector3& position, const Vector3& scale, const Quaternion& orientation)
{
