...
scene1()
{
    ${DIR_file}/binary/z${serverid}_scene1 --worldid=${serverid} --stop=SCENE_SERVICE-1,AI_SERVICE-1 --logpath=/data/log/zone_${serverid}/scene1
}

scene2()
{
    ${DIR_file}/binary/z${serverid}_scene2 --worldid=${serverid} --stop=SCENE_SERVICE-2,AI_SERVICE-2 --logpath=/data/log/zone_${serverid}/scene2
}

scene3()
{
    ${DIR_file}/binary/z${serverid}_scene3 --worldid=${serverid} --stop=SCENE_SERVICE-3,AI_SERVICE-3 --logpath=/data/log/zone_${serverid}/scene3
}

scene4()
{
    ${DIR_file}/binary/z${serverid}_scene4 --worldid=${serverid} --stop=SCENE_SERVICE-4,AI_SERVICE-4 --logpath=/data/log/zone_${serverid}/scene4
}

scene5()
{
    ${DIR_file}/binary/z${serverid}_scene5 --worldid=${serverid} --stop=SCENE_SERVICE-5,AI_SERVICE-5 --logpath=/data/log/zone_${serverid}/scene5
}
