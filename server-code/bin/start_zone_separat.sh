...
${DIR_file}/binary/z${serverid}_scene1 --worldid=${serverid} --start=SCENE_SERVICE-1,AI_SERVICE-1 --logpath=/data/log/zone_${serverid}/zone1 -d
${DIR_file}/binary/z${serverid}_scene2 --worldid=${serverid} --start=SCENE_SERVICE-2,AI_SERVICE-2 --logpath=/data/log/zone_${serverid}/zone2 -d
${DIR_file}/binary/z${serverid}_scene3 --worldid=${serverid} --start=SCENE_SERVICE-3,AI_SERVICE-3 --logpath=/data/log/zone_${serverid}/zone3 -d
${DIR_file}/binary/z${serverid}_scene4 --worldid=${serverid} --start=SCENE_SERVICE-4,AI_SERVICE-4 --logpath=/data/log/zone_${serverid}/zone4 -d
${DIR_file}/binary/z${serverid}_scene5 --worldid=${serverid} --start=SCENE_SERVICE-5,AI_SERVICE-5 --logpath=/data/log/zone_${serverid}/zone5 -d
