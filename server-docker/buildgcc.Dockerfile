...
ADD aliyun1404.list /root/aliyun.list
RUN cp /root/aliyun.list /etc/apt/sources.list
...
#ADD toolschain.list /root/toolschain.list
#RUN cp /root/toolschain.list /etc/apt/sources.list.d/toolschain.list
