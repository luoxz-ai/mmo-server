...
CREATE TABLE `tbld_commondata` (
  ...
  `keyidx` bigint(20) UNSIGNED  NOT NULL DEFAULT '0' COMMENT '数据编号',
...
CREATE TABLE `tbld_cooldown` (
  ...
  `keyidx` bigint(20) UNSIGNED  NOT NULL DEFAULT '0' COMMENT 'CD编号',
...
CREATE TABLE `tbld_datacount` (
  ...
  `keyidx` bigint(20) UNSIGNED  NOT NULL DEFAULT '0' COMMENT 'data编号',
...
CREATE TABLE `tbld_systemvar` (
  `keyidx` bigint(20) UNSIGNED   AUTO_INCREMENT COMMENT '',
