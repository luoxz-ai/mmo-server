...
CREATE TABLE `tbld_guild` (
  ...
  `leader_name` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '帮主名称',
  `creator_id` bigint(32) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建人ID',
  `creator_name` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '创建人名称',
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '创帮时间',
  `del_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '删除时间',
  `slogan` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '口号',
  `info1` varchar(1024) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '信息',
  `info2` varchar(1024) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '信息',
  `info3` varchar(1024) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '信息',
...
CREATE TABLE `tbld_player` (
  ...
  `openid` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '玩家账号',
  ...
  `mate_name` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '伴侣名字',
...
CREATE TABLE `tbld_status` (
  ...
  `pause` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '是否暂停',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tbld_systemvar` (
  ...
  `name` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '系统变量名',
  `data0` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '数据1',
  `data1` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '数据2',
  `data2` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '数据3',
  `data3` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '数据4',
  `str0` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '文字1',
  `str1` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '文字2',
  `str2` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '文字3',
  `str3` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '文字4',
  PRIMARY KEY (`keyidx`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
